...
public final class AStarfarer83 {
...
//		return 1;
//		return (int)(Math.abs(getX(srcPos) - getX(trgPos)) + Math.abs(getY(srcPos) - getY(trgPos)) / 1.5);
	...
	public AStarfarer83(Pathfindable[][] map, int srcX, int srcY, int trgX, int trgY) {
		this.map = map;
